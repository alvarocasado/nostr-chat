  ...
  return (
    <div className="fixed inset-0 z-40 bg-gray-950 flex flex-col">
      ...
      <div className="flex-1 relative flex items-center justify-center">
        ...
        {mediaType === 'video' && (
          <div className="absolute bottom-4 right-4 w-28 h-40 rounded-2xl overflow-hidden border-2 border-gray-700 bg-gray-800 shadow-xl">
      ...
      {/* Controls */}
      <div className="flex items-center justify-center gap-6 pb-safe px-6 py-8 bg-gradient-to-t from-gray-950/90 to-transparent">
        <button
          onClick={toggleMute}
          className={`w-14 h-14 rounded-full flex items-center justify-center transition-colors ${
            isMuted ? 'bg-red-500/30 text-red-400' : 'bg-gray-800 text-white hover:bg-gray-700'
          }`}
        ...
        {mediaType === 'video' && (
          <button
            ...
            className={`w-14 h-14 rounded-full flex items-center justify-center transition-colors ${
              isCameraOff ? 'bg-red-500/30 text-red-400' : 'bg-gray-800 text-white hover:bg-gray-700'
            }`}
        ...
        {/* Spacer buttons for symmetry */}
        {mediaType === 'audio' && <div className="w-14 h-14" />}
      </div>

      {/* Minimal status bar for audio-only */}
