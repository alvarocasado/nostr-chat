...
import { Hash, MessageCircle, MessageCirclePlus, SquarePlus, Users, Settings, LogOut, Zap, X, Search, Bell, User, Wifi, Key, Phone, Shield, Paperclip } from 'lucide-react'
import { useNostrStore, type ChatType } from '../../store/nostrStore'
...
import { SearchResultItem, ChannelItem, ContactItem, GroupItem, type SearchResult } from './SidebarItems'
